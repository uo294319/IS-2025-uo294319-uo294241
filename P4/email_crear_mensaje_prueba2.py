...
if __name__ == '__main__':
    ...
    try:
        ...
        # MAIL FROM
        cmd = f'MAIL FROM:{mensaje['From']}\r\n'.encode()
        clientSocket.sendall(cmd)
        RecvReply(clientSocket, b'250') # 250 OK

        # RCPT TO
        cmd = f'RCPT TO:{mensaje["To"]}\r\n'.encode()
        clientSocket.sendall(cmd)
        RecvReply(clientSocket, b'250') # 250 OK
        ...
        clientSocket.sendall((mensaje.get_content() + "\r\n.\r\n").encode())
